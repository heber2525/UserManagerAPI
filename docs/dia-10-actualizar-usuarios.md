...
Es cambiar solo algunos campos de un usuario, no todo el objeto.

---

### Solo name vs todo el usuario

- Solo `name`: se cambia ese campo y lo demás sigue igual.
- Todo el usuario: puedes sobrescribir datos sin querer.

---

### Por qué no se puede cambiar id o role

- `id`: identifica al usuario y no debe cambiar.
- `role`: controla permisos (USER/ADMIN) y sería un riesgo de seguridad.
